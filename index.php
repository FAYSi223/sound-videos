...
<style>
  ...
  .dark-mode input[type="file"], .dark-mode input[type="text"], .dark-mode form button {
    border-color: #fff; 
    background-color: #333; 
    color: #fff; 
  }
...
<body>
  ...
  <div class="news">UPDATE: Add Contact</div>
  <div class="note">Note: Pls Upload only Pictures, you can upload videos in the future</div>
  <a href="index.php">
    <h1>Sound Videos</h1>
  </a>
  <form id="filterForm">
  ...
  <div class="popup" id="uploadPopup" style="display: none;">
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <button type="submit" class="upload-button">Datei hochladen</button>
    </form>
  </div>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $allowedExtensions = array('mp4', 'mov', 'avi', 'mp3', 'wav', 'png', 'jpg', 'jpeg', 'webp', 'gif', 'mpg', 'mpeg', 'mpe', 'mpg', 'mpe', 'mpg');
      ...
      if (in_array($fileExt, $allowedExtensions)) {
          ...
          if ($fileError === 0) {
              ...
              if (!file_exists($uploadPath)) {
                  ...
                  if (move_uploaded_file($fileTmpName, $uploadPath)) {
                      ...
                      echo "Dein Datei ist nun Online <3";
                      echo "<br>";
          ...
          echo "Ungültiger Dateityp. Bitte laden Sie nur Videos, Audios oder Bilder hoch.";
      }
  }
  ?>
